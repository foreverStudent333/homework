...
class InMemoryUserManagerTest {
    ...
    void setUp() {
        ...
        habitsManager = new InMemoryHabitsManager();
    ...
    void resetAllDoneDailyHabits() {
        habitsManager.addNewHabit(user1,new Habit("1","1",1));
        habitsManager.addNewHabit(user1,new Habit("2","2",1));
        habitsManager.addNewHabit(user1,new Habit("3","3",1));
